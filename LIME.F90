...
contains
  ...
  subroutine dbgcsv(msg,val,i,j,root)
    ...
    !
    ! To turn off, either 
    ! #define dbgcsv_silent ! rundeck <-- doesn't seem to work?
    ! EXTRA_FFLAGS="-Ddbgcsv_silent" ! make setup <-- works
    ...
    ! iso8601
    write(tmp_str, '(I0.4,"-",I0.2,"-",I0.2,"T",I0.2,":",I0.2,":",I0.2)') y,m,d,h,mm,s
    out_str = tmp_str
